<template>
  <div class="dropzone">
    ...
    <el-card class="card">
      <div class="line" />
      <div class="dropzoneHeader">技能信息管理</div>
    </el-card>
    <!-- 技能信息管理表格 -->
    <el-card>
      <el-row>
      ...
      >
        ...
        <el-table-column
          ...
          type="index"
        />
        <el-table-column label="技能编码" prop="skillid" align="center" />
        <el-table-column label="技能名称" prop="skillname" align="center" />
        <el-table-column label="技能等级" prop="gradename" align="center" />
    ...
    >
      <el-form
        ...
        class="demo-ruleForm"
      >
        <el-tooltip effect="dark" content="技能编码只读（系统自动获取）" placement="top-start">
          <i class="el-icon-question" style="color:orange;font-size:18px;position:absolute;top:64px;left:14px;" />
        </el-tooltip>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="技能编码 :" style="margin-left:-52px">
              <el-input v-model="form.code" style="width: 180px" placeholder="(只读)技能编码" readonly />
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="技能名称 :" prop="name" style="margin-left:-38px">
              <el-input v-model="form.name" style="width: 180px" clearable placeholder="请输入技能名称" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="技能等级 : " prop="workshopcode" style="margin-left:-52px">
