...
// 审核页面
export default function AwardAuditDetail(props: GT.Modal.Props & {recordId: number, onlyShow?: string} ) {
  const [form] = useForm();
  ...
  return loadingFlag ? (
    ...
    <div className="csdrawer_list">
      <div className="form_drawer_detail">
        {/* Row */}
        <Row>
          <Col span={24}>
      ...
      {/* {showButton? ( */}
        <div style={{display: "block", width: '700px', height: '74px', backgroundColor: 'white'}}>
        </div>
      {/* ) : null} */}
        {/* {showButton ? ( */}
