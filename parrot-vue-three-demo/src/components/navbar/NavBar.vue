  ...
  <div id="nav-bar">
    ...
    <div id="menuContainer">
      ...
      <div
        ...
        v-bind:class="{
          actived: menu.contentWrapperView == getContentWrapperCurrentView,
        }"
        :key="index"
        @click="routeTo(menu)"
      >
        <div class="nav-menuWrapper">
          ...
          <img class="menuIcon" :src="menu.menuIcon" />
...
var devDataPath = '../../tomahawk/asset/data/'
...
export default { 
      ...
      menuConfig: [
        {
          ...
          menuIcon: devDataPath + "overview.svg",
          actived: true,
        },
        {
          menuName: "实时物流",
          ...
          menuIcon: devDataPath + "realtime.svg",
          actived: false,
        },
        {
          menuName: "绩效分析",
          ...
          menuIcon: devDataPath+ "statistic.svg",
          actived: false,
        },
        {
          menuName: "网点监控",
  ...
  computed: {
      ...mapGetters(['getContentWrapperCurrentView','getStaticAssetPath']),
  },
  components: {},
  methods: {
    ...
    ...mapActions(['setContentWrapperView'])
  },
  mounted: function() {
    console.log(this.getStaticAssetPath)
    var _self = this;
    document
      .getElementById("work-description")
      .addEventListener("click", _self.goHome, false);
  },
};
</script>
...
#nav-bar .navbar {
  ...
  background: -moz-linear-gradient(50%, #282c33, #131418);
  border-style: none;
